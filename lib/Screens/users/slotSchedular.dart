...
import '../../widgets/slots/durationGap.dart';
import '../../widgets/slots/multiSelectChip.dart';
import '../../widgets/slots/staticCard.dart';
      ...
      onTap: () {
        if (toDouble(endTime!) > toDouble(startTime!)) {
          ...
          ScaffoldMessenger.of(context)
              .showSnackBar(const SnackBar(content: Text("Invalid Time : End Time Should not be less than start timne ")));
        }
      },
      child: Card(
        child: Padding(
